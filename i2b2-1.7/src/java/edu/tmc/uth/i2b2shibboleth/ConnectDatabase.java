...
public class ConnectDatabase implements HttpSessionBindingListener {
    ...
    public Connection connectToDatabase() {
        try {
            ...
            properties = ResourceBundle.getBundle("uwhealth/i2b2/shibboleth/database");
    ...
    public void setShibbolethAttributes() {
        ...
        // uwhealth implementation:
        String identifier = request.getHeader("uid");
        String session = request.getHeader("Shib-Session-ID");
        this.user = new User(identifier, session);
        this.test.add("Basic User attributes");
        this.test.add(this.user.toString());
        this.test.add("All Shibboleth headers");
    ...
    private void updateI2b2UserDatabase() throws SQLException {
        ...
        // UW Health prefers to add users to authorization table manually
