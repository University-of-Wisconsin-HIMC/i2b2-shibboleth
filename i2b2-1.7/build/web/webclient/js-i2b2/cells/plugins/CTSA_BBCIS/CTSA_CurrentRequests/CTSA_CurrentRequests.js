 ...
 * @inherits	i2b2
 * @namespace	i2b2.CTSA_CurrentRequests
...
i2b2.CTSA_CurrentRequests.Init = function(loadedDiv) {
	// this function is called after the HTML is loaded into the viewer DIV
	// find all the drop targets by style for PRS type
	i2b2.CTSA_CurrentRequests.view.containerDiv = loadedDiv;
	
	// alert("Hello World! This message is from the initalization routine.");
	
};

i2b2.CTSA_CurrentRequests.Unload = function() {
...
i2b2.CTSA_CurrentRequests.Resize = function(resizeInfo) {
