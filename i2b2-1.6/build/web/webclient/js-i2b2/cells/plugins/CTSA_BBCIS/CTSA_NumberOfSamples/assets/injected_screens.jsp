...
<html>
    ...
    <body>
		<div id='CTSA_NumberOfSamples-mainDiv'>

			<div id="CTSA_NumberOfSamples-TABS" class="yui-navset">
				<ul class="yui-nav">
					<li id="CTSA_NumberOfSamples-TAB0" class="selected"><a href="#CTSA_NumberOfSamples-TAB0"><em>Select a Query</em></a></li>
					<li id="CTSA_NumberOfSamples-TAB1"><a href="#CTSA_NumberOfSamples-TAB1"><em>Confirm Query</em></a></li>
					<li id="CTSA_NumberOfSamples-TAB2"><a href="#CTSA_NumberOfSamples-TAB2"><em>Plugin Help</em></a></li>
				</ul>
				<div class="yui-content" id="CTSA_NumberOfSamples-CONTENT">
					<div>
						<div class="CTSA_NumberOfSamples-MainContent">
							<div class="CTSA_NumberOfSamples-MainContentPad">
								...
								<div class="droptrgt SDX-PRS" id="CTSA_NumberOfSamples-PRSDROP" style="">Drop a query here</div>
								<br>
								<div class="qxmllbl">Number of Samples for This Sample:</div>
								<div class="qxmltrgt" id="CTSA_NumberOfSamples-queryXml">Number of Samples Will Be Shown Here</div>
							</div>
						</div>
					</div>
					<div>
						<div class="CTSA_NumberOfSamples-MainContent">
							...
							<div class="results-finished" style="display:none;">
								...
								<div id="CTSA_NumberOfSamples-InfoSDX">
									<table>
